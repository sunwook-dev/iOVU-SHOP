...
export default function Home({ lang }) {
  ...
  usePageSEO({
    title: messages[lang]?.welcome + ' | iOVU Shop',
    description: messages[lang]?.subtitle,
    canonical: `https://iovu-shop.vercel.app/${lang}/`,
    alternates: [
      { href: 'https://iovu-shop.vercel.app/ko/', hreflang: 'ko' },
      { href: 'https://iovu-shop.vercel.app/en/', hreflang: 'en' },
      { href: 'https://iovu-shop.vercel.app/', hreflang: 'x-default' }
    ]
  });
