...
export default function FAQ({ lang }) {
  const { lang: currentLang } = useParams(); // Keep this line as it's not explicitly removed
  ...
  const currentMessages = messages[currentLang] || messages.ko;
  ...
  usePageSEO({
    ...
    canonical: `https://iovu-shop.vercel.app/${currentLang}/faq`,
    alternates: [
      { href: `https://iovu-shop.vercel.app/ko/faq`, hreflang: 'ko' },
      { href: `https://iovu-shop.vercel.app/en/faq`, hreflang: 'en' },
      { href: `https://iovu-shop.vercel.app/faq`, hreflang: 'x-default' }
    ]
  });
