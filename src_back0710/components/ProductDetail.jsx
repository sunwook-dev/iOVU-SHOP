...
function ProductDetail() {
  ...
  return (
    <Box sx={{ minHeight: "100%", width: "100%", py: 5 }}>
      <Helmet>
        <link rel="canonical" href={`https://iovu-shop.vercel.app/${lang}/product/${id}`} />
        <link rel="alternate" href={`${baseUrl}/ko/product/${id}`} hreflang="ko" />
        <link rel="alternate" href={`${baseUrl}/en/product/${id}`} hreflang="en" />
        <link rel="alternate" href={baseUrl + "/product/" + id} hreflang="x-default" />
        {productJsonLd && (
