  ...
  return (
    <Box sx={{ minHeight: '70vh', bgcolor: '#fafafa', py: 4 }}>
      <Container maxWidth="lg">
        <Helmet>
          <title>{title} | iOVU Shop</title>
          <link rel="canonical" href={`https://iovu-shop.vercel.app/${lang}/category/${type}`} />
          <link rel="alternate" href={`${baseUrl}/ko/category/${type}`} hreflang="ko" />
          <link rel="alternate" href={`${baseUrl}/en/category/${type}`} hreflang="en" />
          <link rel="alternate" href={baseUrl + "/category/" + type} hreflang="x-default" />
        </Helmet>
